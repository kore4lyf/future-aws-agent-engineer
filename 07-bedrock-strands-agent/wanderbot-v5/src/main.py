...
GATEWAY_ENDPOINT = "https://wanderbot-gateway-foziumjcew.gateway.bedrock-agentcore.us-east-1.amazonaws.com/mcp"
...
async def invoke(payload: dict, context=None):
    ...
    hooks = [ShortTermMemoryHookProvider(memory_client=memory_client, memory_id=MEMORY_ID)]
